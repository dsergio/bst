...
public class Tester {
	...
	public static void main(String[] args) {
		...
		CloudBST cloudBST = new CloudBST("animal_tree2");
...
//		System.out.println(cloudBST.contains("J"));
...
//			cloudBST.insert(animals[x]);
		}
		cloudBST.inorderTraversal();
